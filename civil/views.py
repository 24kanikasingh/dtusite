...
def index(request):
    ...
    return render(request, 'civil/civil_faculty.htm', context)

def detail(request, teacher_id):
    teacher = get_object_or_404(Teacher, pk=teacher_id)
##    if request.method == "POST":
##        submit(request,teacher_id)
    return render(request, 'civil/details.htm', {'teacher': teacher})
...
def vote(request, teacher_id):
    ...
    teacher = get_object_or_404(Teacher, pk=teacher_id)
    return render(request, 'civil/form.htm', {'teacher': teacher})
...
def get_form(request,teacher_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            #return HttpResponseRedirect('/civil/'+teacher_id)
            return render(request, 'civil/details.htm', {'teacher': teacher})
    ...
    return render(request, 'civil/form.htm', {'form': form,'teacher':teacher})        
