...
def index(request):
    ...
    return render(request, 'electrical/electrical_faculty.htm', context)

def detail(request, teacher_id):
    teacher = get_object_or_404(Teacher, pk=teacher_id)
##    if request.method == "POST":
##        submit(request,teacher_id)
    return render(request, 'electrical/details.htm', {'teacher': teacher})
...
def vote(request, teacher_id):
    ...
    teacher = get_object_or_404(Teacher, pk=teacher_id)
    return render(request, 'electrical/form.htm', {'teacher': teacher})
...
def get_form(request,teacher_id):
    ...
    return render(request, 'electrical/form.htm', {'form': form,'teacher':teacher})        
